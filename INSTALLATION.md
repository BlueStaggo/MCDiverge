...
1. Download the minecraft.zip file (not source code!) from [the latest release](https://github.com/BlueStaggo/MCDiverge/releases).
...
## Betacraft (Manual)
1. Download the mcdiverge.info file from [the latest release](https://github.com/BlueStaggo/MCDiverge/releases).
2. Move the .info file to the location corresponding to your OS:
...
2. Download the minecraft_server.zip file from [the latest release](https://github.com/BlueStaggo/MCDiverge/releases).
...
## Official Minecraft launcher / Pojav Launcher
